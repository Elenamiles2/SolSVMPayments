//! SolSVM's "account loader" component, which provides the SVM API with the
//! ability to load accounts for SolSVM channels.
//!
...
impl TransactionProcessingCallback for SolSVMAccountLoader<'_> {
